...
function AtendimentoCard({ os }: { os: OSCardData }) {
  ...
  return (
    <Link
      ...
      className="group block"
    >
      <Card className="relative overflow-hidden border-primary/40 bg-gradient-to-br from-primary/5 via-primary/10 to-primary/20 p-4 shadow-md transition-all hover:shadow-lg group-hover:-translate-y-0.5">
        <div className="flex items-center gap-4">
          ...
          <div className="hidden h-14 w-px shrink-0 bg-primary/20 sm:block" />

          <div className="hidden min-w-[10rem] shrink-0 flex-col items-end gap-1 sm:flex">
            {os.placa && (
