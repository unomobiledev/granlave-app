...
export const STAGES: Stage[] = [
  {
    ...
    checklist: [
      { id: "motorista", label: "Nome do motorista", type: "text", placeholder: "Nome completo" },
      { id: "transportador", label: "Transportador", type: "text", placeholder: "Razão social" },
      { id: "industria", label: "Indústria de carregamento", type: "text", placeholder: "Ex: BRF / Bunge / Cargill" },
      {
        id: "tipo_veiculo",
        label: "Tipo de veículo",
        type: "select",
        options: [
          "Truck Tanque (1 placa)",
          "Cavalo / Carreta Tanque (2 placas)",
          "Cavalo / Bitren e Rodotren (3 placas)",
        ],
      },
      { id: "placas_extra", label: "Placas adicionais (se houver)", type: "text", placeholder: "Ex: ABC-1234 / DEF-5678" },
      { id: "produto_higienizar", label: "Tipo de produto a higienizar", type: "text", placeholder: "Ex: Óleo de soja" },
      { id: "ultima_carga", label: "Última carga", type: "text", placeholder: "Produto" },
      { id: "penultima_carga", label: "Penúltima carga", type: "text", placeholder: "Produto" },
      { id: "antepenultima_carga", label: "Antepenúltima carga", type: "text", placeholder: "Produto" },
      {
      ...
      { id: "anvisa", label: "Registro Anvisa", type: "text", placeholder: "Nº do registro" },
      { id: "lote", label: "Nº do lote", type: "text", placeholder: "Nº do lote" },
      { id: "posicao_fila", label: "Posição na fila", type: "text", placeholder: "Ex: 1" },
    ],
  },
  {
    id: 2,
